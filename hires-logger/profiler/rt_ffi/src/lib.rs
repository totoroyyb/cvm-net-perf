...
// Remove manual definitions if using bindgen
/*
use core::ffi::{c_char, c_void, c_uint, c_ushort, c_int}; // Add c_int if needed

// Opaque handle type
#[repr(C)] pub struct HiResLoggerConnHandle { _private: [u8; 0] }
...
extern "C" {
    // Rename functions to match C API header (hires_*)
    pub fn hires_connect(device_path: *const c_char) -> *mut HiResLoggerConnHandle;
    ...
    pub fn hires_get_buffer_size(handle: *mut HiResLoggerConnHandle) -> usize;
    pub fn hires_get_last_error() -> *const c_char;
}
*/
